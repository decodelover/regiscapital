@php
    $flashType = strtolower((string) Session::get('type'));
    $showSuccess = Session::has('success') || (Session::has('message') && $flashType === 'success');
    $successMessage = Session::get('success') ?: Session::get('message');
@endphp
