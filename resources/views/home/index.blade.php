                        ...
                        <div class="item">
                            <div class="col-md-8 col-lg-7 col-12">
                                ...
                                <!-- <span class="text-uppercase"><span >05:50pm</span> <b style="color: #f49917;" >Aug 14, 2021</b></span>-->
                                    ...
                                    <p class="lead">{{$settings->site_name}} is the best and secured way of performing transactions to people all over the world. No matter where you are in the world, you can save and transact with people conveniently and confidently</p>
                                    ...
                                    <div class="action-btns mt-4">
                                        <a href="register" class="btn secondary-solid-btn mr-3">Open Account</a>
                                        <a href="login" class="btn outline-white-btn">Online Banking</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-md-8 col-lg-7 col-12">
                                <div class="hero-content-wrap text-white">
                                    ...
                                    <div class="action-btns mt-4">
                                        <a href="register" class="btn secondary-solid-btn mr-3">Create account</a>
                                        <a href="login" class="btn outline-white-btn">Online Banking</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-3 col-lg-3">
                    <div class="single-promo-block p-3 rounded d-flex justify-content-between">
                        ...
                        <div class="promo-block-content">
                            ...
                            <p>{{$settings->site_name}} Bank offers a wide range of loans to suit your needs</p>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-12 col-lg-5">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        ...
                        <p>Our company, "{{$settings->site_name}}", was founded in 2012 by a group of socially-minded entrepreneurs who saw the need for accessible financial services for low-income individuals and small businesses. They believed that by providing small loans and other financial services to these underbanked populations, they could help to promote economic growth and reduce poverty in their community.<br>

                        In the early days, {{$settings->site_name}} focused on providing small loans to micro-entrepreneurs in their local area. They quickly realized that there was a high demand for their services and decided to expand their operations by opening new branches in other cities.<br>
                        ...
                        In 2013, {{$settings->site_name}} received an investment from a major venture capital firm, which allowed them to scale up their operations and expand into new markets. By 2015, {{$settings->site_name}} had become one of the largest microfinance companies in the country, serving thousands of customers and providing millions of dollars in loans and other financial services.<br>
