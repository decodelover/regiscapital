        ...
        <div class="row justify-content-around">
            ...
            <div class="col-md-12 col-lg-5">
                <div class="about-content-right mb-md-4 mb-lg-0">
                    <h2>About Us</h2>
                    <p>A few years ago, a small team of people determined to transform banking launched a savings app for everyone. That app was the first step toward {{$settings->site_name}} Bank.
                    ...
                    <div class="feature-tabs-wrap">
                        ...
                        <div class="tab-content feature-tab-content">
                            <div class="tab-pane active" id="feature-tab-2">
                                <p>The goal of {{$settings->site_name}} Bank is to provide its users a unique, safe and secured platform for
                            ...
                            <div class="tab-pane" id="feature-tab-3">
                                <p>We always try to expand our technical capabilities and financial prowess with the help of latest and advanced fintech technologies to facilitate transactions.<br><br>
                                    ...
                                    {{$settings->site_name}} Bank envisions to widen our customer reach to people of different races, countries and continents.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-md-12 col-lg-12">
                <div class="video-promo-content mb-md-4 mb-lg-0">
                    ...
                    <p>Our company, "{{$settings->site_name}} Bank", was founded in 2012 by a group of socially-minded entrepreneurs who saw the need for accessible financial services for low-income individuals and small businesses. They believed that by providing small loans and other financial services to these underbanked populations, they could help to promote economic growth and reduce poverty in their community.<br><br>

                    In the early days, {{$settings->site_name}} Bank focused on providing small loans to micro-entrepreneurs in their local area. They quickly realized that there was a high demand for their services and decided to expand their operations by opening new branches in other cities.<br><br>
                    ...
                    In 2013, {{$settings->site_name}} Bank received an investment from a major venture capital firm, which allowed them to scale up their operations and expand into new markets. By 2015, {{$settings->site_name}} Bank had become one of the largest microfinance companies in the country, serving thousands of customers and providing millions of dollars in loans and other financial services.<br><br>

                    Throughout its history, {{$settings->site_name}} Bank has always been guided by its mission to empower the underbanked and promote economic growth. The company's impact can be seen in the many small businesses that have been able to grow and create jobs as a result of their services, and the many families who have been able to improve their standard of living. {{$settings->site_name}} Bank remains committed to its mission and to providing affordable financial services to underserved communities
                    </p>
                </div>
            </div>
