                        ...
                        <table id="ShipTable" class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($plans as $plan)
                                    ...
                                    @endphp
                                    <tr>
                                        <td>{{ $loanUser->name ?? 'Unknown user' }}</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    @if(!empty($loanUser) && !empty($loanUser->id))
                                                        <a class="dropdown-item"
                                                            href="{{ route('user.plans', $loanUser->id) }}">More actions</a>
                                                    @else
                                                        <span class="dropdown-item text-muted">User record not found</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
