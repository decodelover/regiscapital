    ...
    <div class="col-md-12">
        <div>
            ...
            <div class="mt-2 alert alert-info">
                <strong>Deposit channels in use:</strong> User deposits currently allow only <strong>Bank Transfer</strong>,
                <strong>Bitcoin</strong>, <strong>Ethereum</strong>, and <strong>USDT</strong>.
                Keep these methods configured and enabled here.
            </div>
            <!-- Modal -->
