                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $card->id }}">
                                                                ...
                                                                @if ($card->status == 'pending')
                                                                    <form action="{{ route('admin.cards.approve', $card->id) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        <button type="submit" class="dropdown-item text-success">
                                                                            <i class="fa fa-check-circle"></i> Approve
                                                                        </button>
                                                                    </form>
                                                                    <form action="{{ route('admin.cards.reject', $card->id) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        <input type="hidden" name="rejection_reason" value="Rejected by admin after review">
                                                                ...
                                                                @if ($card->status == 'active')
                                                                    <form action="{{ route('admin.cards.block', $card->id) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                ...
                                                                @if ($card->status == 'blocked' || $card->status == 'inactive')
                                                                    <form action="{{ route('admin.cards.unblock', $card->id) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        <button type="submit" class="dropdown-item text-success">
