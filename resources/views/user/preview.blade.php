                ...
                <div class="relative bg-gradient-to-r from-primary-600 to-primary-700 px-6 py-8 text-white">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <img class="h-12 w-auto" src="{{ $brandLogoUrl }}" alt="{{ $settings->site_name }}">
                            <div class="ml-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm font-medium text-gray-900">{{ \Carbon\Carbon::parse($dp->created_at)->toDayDateTimeString() }}
