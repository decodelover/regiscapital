...
Route::get('/debug-test', function () {
    dd([
        'env_APP_DEBUG' => env('APP_DEBUG'),              // raw .env value
        'config_app_debug' => config('app.debug'),        // value used by Laravel
        'config_cached' => app()->configurationIsCached() // should be false unless you ran config:cache
    ]);
});