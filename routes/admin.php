...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	Route::get('dashboard/rdeposit/{id}', [ManageDepositController::class, 'rdeposit'])->name('rdeposit');
	...
	*/
	...
	Route::post('cards/approve/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'approveCard'])->name('admin.cards.approve');
	Route::post('cards/reject/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'rejectCard'])->name('admin.cards.reject');
	Route::post('cards/block/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'blockCard'])->name('admin.cards.block');
	Route::post('cards/unblock/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'unblockCard'])->name('admin.cards.unblock');
	...
	Route::delete('cards/{id}', [App\Http\Controllers\Admin\VirtualCardController::class, 'deleteCard'])->name('admin.cards.delete');
